    ...
    <div className="container">
          ...
          <div className="details">
            ...
            <div className="info-grid">
              <div className="full-width">
                <label>Colégio</label>
                <p>(GENIUS - CAMPINAS - SP - CAMPINAS/SP)</p>
              </div>
              <div>
                <label>Curso</label>
                <p>Ensino Médio</p>
      ...
      <footer className="footer">
        <div className="footer-left">
          ...
          <br />
          <span>Pixel Gráfica, Editora E Produtos Digitais LTDA - 10.709.188/0001.03 - © 2025 School Picture - Todos os direitos reservados</span>
          <br />
          <span></span>
        </div>
